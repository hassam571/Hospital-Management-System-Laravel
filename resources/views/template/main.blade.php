    ...
    <body onload="startTime();setdate()" class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        @if ($user_type != 'Pharmacist')
                            ...
                            <li
                                ...
                                <ul class="treeview-menu">
                                    <li class="{{ Active::checkRoute('patient') }}"><a
                                            href="{{ route('patient') }}"></i><i class="fas fa-user-plus"
                                                aria-hidden="true"></i>
                                            Register New</a></li>
                        ...
                        @if ($user_type == 'Admin' || $user_type == 'Doctor')
                            ...
                            <li class="{{ Active::checkRoute('check_patient_view') }}"><a
                                    href="{{ route('check_patient_view') }}"><i class="fas fa-procedures"></i><span>
                                        Check
                                        Patient</span></a></li>
                        @endif
                        ...
                        @if ($user_type == 'Pharmacist' || $user_type == 'Admin')
                            {{-- Issue Medicine --}}
                            <li class="{{ Active::checkRoute('issueMedicineView') }}"><a
                                    href="{{ route('issueMedicineView') }}"><i class="fa fa-plus-square"></i><span>Issue
                                        Medicine</span></a></li>
                        @endif
                        ...
                        <li class="treeview {{ Active::checkRoute(['attendmore', 'myattend']) }}">
                            ...
                            <ul class="treeview-menu">
                                ...
                                @if ($user_type == 'Admssin')
                                    <li class="{{ Active::checkRoute('attendmore') }}"><a
                                            href="{{ route('attendmore') }}"><i class="fas fa-plus-square"
                        ...
                        <li
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="{{ Active::checkRoute('attendance_report') }}"><a
                                        href="{{ route('attendance_report') }}"><i
                                            class="fa fa-clipboard
                                            aria-hidden="
                                            true"></i> Attendance Report</a></li>
                            </ul>
                        </li>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; {{ date('Y') }} <a href="#">Smart Hospital Systems</a>.</strong> All
                rights reserved.
            </footer>
